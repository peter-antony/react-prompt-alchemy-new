  ...
  return (
    <div className={`flex items-center justify-between w-full
      ...
      {!hideRightToolbar && <div className="flex items-center space-x-3">
        ...
        {gridTitle !== "Item Service" && onToggleServersideFilter && gridTitle !== "Leg Details" && (
          <div className="relative">
            <Button
              variant="ghost"
              size="sm"
  ...
  >
    {areAllRowsExpanded ? (
      ...
      <ChevronRight className="h-4 w-4" />
        ...
        {gridTitle !== "Item Service" && (gridTitle !== 'Plan List' && gridTitle !== 'Actual List' && gridTitle !== 'Leg Details') && (
          <Button
            variant="ghost"
            size="sm"
        ...
        {gridTitle !== "Item Service" && buttonsToShow.map((buttonConfig, index) => (
          <ConfigurableButton
            key={index}
            config={buttonConfig}
          />
