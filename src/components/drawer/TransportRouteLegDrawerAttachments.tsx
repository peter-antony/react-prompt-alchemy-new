...
const TransportRouteLegDrawerAttachments = ({
  ...
  const handleUpload = async (files: StagedFile[]) => {
    ...
    try {
      for (const file of files) {
        ...
        // );
        const response: any = await tripService.saveTransportRouteUpdateAttachments(
          fileData,
          tripUniqueID ? tripUniqueID : tripId
        );
...
export default TransportRouteLegDrawerAttachments;
