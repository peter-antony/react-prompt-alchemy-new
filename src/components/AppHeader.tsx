...
import { Search, Bell, Settings, User, Filter, Download, MoreHorizontal, Moon, X } from 'lucide-react';
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          <input
            ...
            type="text"
            placeholder="Search"
            className="w-52 h-[28px] pl-4 pr-4 searchBG font-color-100 rounded-lg text-[11px] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className="w-8 h-8 bg-purple-200 rounded-full cursor-pointer flex items-center justify-center border-2 border-white shadow-md">
