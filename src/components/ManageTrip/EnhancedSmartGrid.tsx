...
export const EnhancedSmartGrid = () => {
  ...
  const subRowEditableColumns: GridColumnConfig[] = [
    ...
    { key: 'PlannedDate', label: 'Planned Date', type: 'Date', width: 160, editable: true },
    { key: 'PlannedTime', label: 'Planned Time', type: 'Time', width: 160, editable: true },
    { key: 'RevisedDate', label: 'Revised Date', type: 'Date', width: 160, editable: true },
    { key: 'RevisedTime', label: 'Revised Time', type: 'Time', width: 160, editable: true },
