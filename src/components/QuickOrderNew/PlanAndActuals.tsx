  ...
  const loadGridData = () => {
    ...
    if (tab === 'planned') {
      ...
      mapped = (arr?.[0]?.PlanDetails ?? []).map((plan: any) => ({
        ...
        WagonQuantity: `${plan?.WagonDetails?.WagonQuantity || ''} ${plan?.WagonDetails?.WagonQuantityUOM || ''}`.replace(/^[-]+|[-]+$/g, ''),
        WagonTareWeight: `${plan?.WagonDetails?.WagonTareWeight || ''} ${plan?.WagonDetails?.WagonTareWeightUOM || ''}`.replace(/^[-]+|[-]+$/g, ''),
        WagonGrossWeight: `${plan?.WagonDetails?.WagonGrossWeight || ''} ${plan?.WagonDetails?.WagonGrossWeightUOM || ''}`.replace(/^[-]+|[-]+$/g, ''),
        WagonLength: `${plan?.WagonDetails?.WagonLength || ''} ${plan?.WagonDetails?.WagonLengthUOM || ''}`.replace(/^[-]+|[-]+$/g, ''),
        ...
        ContainerQuantity: `${plan?.ContainerDetails?.ContainerQuantity || ''} ${plan?.ContainerDetails?.ContainerQuantityUOM || ''}`.replace(/^[-]+|[-]+$/g, ''),
        ContainerTareWeight: `${plan?.ContainerDetails?.ContainerTareWeight || ''} ${plan?.ContainerDetails?.ContainerTareWeightUOM || ''}`.replace(/^[-]+|[-]+$/g, ''),
        ContainerLoadWeight: `${plan?.ContainerDetails?.ContainerLoadWeight || ''} ${plan?.ContainerDetails?.ContainerLoadWeightUOM || ''}`.replace(/^[-]+|[-]+$/g, ''),
        ...
        ProductQuantity: `${plan?.ProductDetails?.ProductQuantity || ''} - ${plan?.ProductDetails?.ProductQuantityUOM || ''}`.replace(/^[-]+|[-]+$/g, ''),
        ...
        THUWeight: `${plan?.THUDetails?.THUWeight || ''} ${plan?.THUDetails?.THUWeightUOM || ''}`.replace(/^[-]+|[-]+$/g, ''),
        THUQuantity: `${plan?.THUDetails?.THUQuantity || ''} ${plan?.THUDetails?.THUQuantityUOM || ''}`.replace(/^[-]+|[-]+$/g, ''),
